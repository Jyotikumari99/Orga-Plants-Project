...
import logo from "../assets/Orga Plants Logo.png";
                ...
                <div className="container col col-sm-4">
                    <div className="row">
                        <div className="col mb-1">
                            ...
                            <div className="bg-light">
                                ...
                                <input type="name" className="form-control ps-5 pe-3" id="firstName" placeholder="Jyoti" />
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col mb-1">
                            ...
                            <div className="bg-light">
                                <i className="bi bi-person position-absolute ps-3 pt-1 fs-5"></i>
                                <input type="name" className="form-control ps-5 pe-3" id="lastName" placeholder="Kumari" />
                            </div>
                        </div>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                        <div className="col mb-1">
                            ...
                            <div className="bg-light">
                                <i class="bi bi-geo-alt position-absolute ps-2 pt-1 fs-5"></i>
                    ...
                    <div className="row">
                        <div className="col mb-2">
                            ...
                            <div className="bg-light">
                                <input type="address" className="form-control ps-2 pe-2" id="pincode" placeholder="560067*" />
                            </div>
                        </div>
                    </div>
                </div>
